...
parser.add_argument('--dataset_root', default='./WHU-MVS/test', help='dataset root')
parser.add_argument('--dataset', default='aerial', help='aerial or satellite', choices=['aerial', 'satellite'])

parser.add_argument('--loadckpt', default='./checkpoints/casmvs/pinhole/model.ckpt',
...
def predict():
    ...
    pre_dataset = MVSDataset(args.dataset_root, "pred", args.view_num, ref_view=args.ref_view, dataset=args.dataset,use_qc=args.use_qc)
    ...
    output_folder = os.path.join(args.dataset_root, '{}_{}_{}'.format(args.dataset, args.model, args.geo_model))
